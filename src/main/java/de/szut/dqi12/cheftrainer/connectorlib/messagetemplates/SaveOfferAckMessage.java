 ...
 *
 */
public class SaveOfferAckMessage extends MessageTemplate {

	private final static String ID= ServerToClient_MessageIDs.SAVE_OFFER_ACK;
	 ...
	 */
	public SaveOfferAckMessage(boolean successful) {
		super(ID);
	 ...
	 */
	public SaveOfferAckMessage(JSONObject json) {
		super(ID);
